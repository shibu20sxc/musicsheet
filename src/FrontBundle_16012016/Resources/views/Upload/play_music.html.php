            ...
            <div class="video_ads_wrap" style="display:none;" id="video_advertisement_{{playlist.id}}">               
                <div class="nano" id="video_ads_wrap">                    
                    <div class="nano-content">
                        ...
                        <div class="video">
                            <iframe width="100%" id="iframeID" height="380" src="" frameborder="0" allowfullscreen></iframe>
                        </div>
...
<script type="text/javascript">
    ...
    app.controller("musicDisplay", function ($scope, $http, $interval) {          
        ...
        $(".nano").nanoScroller();
            ...
            $.ajax({                    
                    ...
                    success: function (response) {
                        ...
                        window.setTimeout(function(){
                            ...
                            window.location.href = $scope.url_const+songs_id;
            ...
            $('#iframeID').attr("src", $scope.ytsrc);
            $('#video_advertisement_'+songs_id).show();
            $('#iframeID').attr("src","<?php echo $advertisement4[0]['advertisements'];?>");
