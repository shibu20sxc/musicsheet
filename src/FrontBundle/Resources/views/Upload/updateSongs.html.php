    ...
    <div class="col-lg-11 col-sm-11 fix_width11 less_rt rt_border">
            ...
            <div class="tab_left_panel nano" id="upload_lt" ng-controller="songsController">
                <ul class="nano-content">
                    ...
                    <li ng-repeat="result in results| filter:songSearch" id="songs_{{result.id}}">
                        <div class="songs"><a href="javascript:void(0);" style="text-decoration: none;" ng-click="updateSongs(result.id);">{{result.song}}</a></div>
                        <div class="artist">by {{result.artist}}</div>
                        <div class="liclose">
                            <a href="javascript:void(0);" ng-click="removeSongs(result.id);">
                            <img src="<?php echo $view['assets']->getUrl('SheetMusic/front/images/close_btn.png'); ?>" alt="Close" />
                            </a>
                        </div>
        ...
        <div class="col-lg-9 col-sm-9">
            <div class="nano" id="upload">
                ...
                <div class="upload_wrap" id = "upload_circle">
                    <div id="circle_bg">
                        <div class="cat_wrap">
                    ...
                    <form class="form-horizontal nano-content" action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <?php
                                foreach ($songDetail as $key => $sheet) {
                                    echo '<a href=' . $sheet['music_sheet_name'] . '> Sheet-' . ($key + 1) . '</a>';
                                }
                                ?>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="file" id="usong" name="usong"> <a href ="<?php echo ($songDetail[0]['music']) ? $songDetail[0]['music'] : ''; ?>"><?php echo ($songDetail[0]['song']) ? $songDetail[0]['song'] : ''; ?></a> 
                            </div>
                        </div>
                ...
                <div class="upload_form_wrap" id = "upload_video" style = "display: none;">
                    <form class="form-horizontal nano-content" action="" method="">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="<?php echo ($songDetail[0]['video']) ? $songDetail[0]['video'] : ''; ?>" class="form-control" name="vlink" id="vlink" placeholder="Paste your youtube video link">
                            </div>
                        </div>
                ...
                <div class="upload_form_wrap" id = "upload_info" style = "display: none;">
                    <form class="form-horizontal nano-content" action="" method="">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" value="<?php echo ($songDetail[0]['song']) ? $songDetail[0]['song'] : ''; ?>" name="song" id="song" placeholder="Song Name">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Artist Name:</label>
                            <div class="col-sm-10">
                                <textarea cols="5" rows="2" style="resize:none;" id = "artist" class="form-control"><?php echo ($songDetail[0]['artist']) ? $songDetail[0]['artist'] : ''; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Album Name:</label>
                            <div class="col-sm-10">
                                <input type="text" value="<?php echo ($songDetail[0]['album']) ? $songDetail[0]['album'] : ''; ?>" class="form-control" name="album" id="album" placeholder="Album Name">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="<?php echo ($songDetail[0]['contributor']) ? $songDetail[0]['contributor'] : ''; ?>" class="form-control" name="contributor" id="contributor" placeholder="Contributor">
                            </div>
                        </div>
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-sm-10">                               
                                <select name="instrument_family" id="instrument_family" class="form-control" ng-model="instrument_family">
                                    ...
                                    <!--<option ng-if="familyId == instrumentFamily.id" value="{{instrumentFamily.id}}" ng-repeat="instrumentFamily in instrumentFamilies">{{instrumentFamily.name}}</option>-->
...
<div class="notification_wrap" id="notify"  style="display:none;" ng-controller="dashboardSubs" style="background: #fff;">
    ...
    <input type="hidden" id="updateSongsId" value="<?php echo $songsId?>"/>
</div>
...
<script>
    ...
    app.controller('instrumentFamily', function ($scope) {
        ...
        $scope.familyId = <?php echo $songDetail[0]['instrument_family']; ?>;
        $scope.instrumentId = <?php echo $songDetail[0]['instrument']; ?>;
    });
    var music_duration;
    $(document).ready(function () {
        ...
        $('#publish').click(function () {
            var songsId = $('#updateSongsId').val();
            $.ajax({
                url: "<?php echo $view['router']->generate('_ajax_update_songs'); ?>",
                type: "POST",
                data: {
