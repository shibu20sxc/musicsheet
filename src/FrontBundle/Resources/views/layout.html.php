...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script>
        var app = angular.module('globalApp', ['ngAnimate']);
    </script>
    ...
    <body>
        <div class="container-fluid main_wrapper" ng-app="globalApp">
            <?php include_once 'navigation.html.php'; ?> 
             <?php include_once 'common_footer.html.php'; ?> 
            <?php if ($view['slots']->has('navigation'))  ?>
            <?php $view['slots']->output('navigation') ?>
            <?php if ($view['slots']->has('body'))  ?>
            <?php $view['slots']->output('body') ?>
            <?php if ($view['slots']->has('common_footer'))  ?>
            <?php $view['slots']->output('common_footer') ?>
        ...
        <div class="login_wrap posion" id="login_box" style="display:none;background: #fff;">
            ...
            <!--<p style="color:red;"><?php if (isset($user_login)) { echo $user_login; }?></p>-->
           ...
           <?php }?>
            <?php if (isset($_GET['register'])) {  ?>
                ...
                bootbox.dialog({
                                message: '<div class="row" style=" color:#666; font-size:18px; text-align:center;"> ' +
                                        'Successfully register ! Thank You for register !' +
                                        '</div>',
                            }
                            );
                </script>
